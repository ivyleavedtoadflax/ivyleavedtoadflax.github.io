...
```{r,journey_route_ggplot,fig.width=9,fig.height=9}
...
```{r,nybikes_pred_vs_actual,fig.width=9,fig.height=9}
...
```{r,nybikes_time_by_journey,fig.height=10,fig.width=6}
...
```{r,nybikes_speed_by_journey,fig.height=10,fig.width=6}
...
```{r,journey_plot_ggmap1,fig.width=9,fig.height=9}
