...
So even with a relatively small dataset of just `r ex2data1 %>% nrow` rows, we find that a vectorised linear regression solved using an optimisation algorithm is many times quicker than applying a generalised linear model.
