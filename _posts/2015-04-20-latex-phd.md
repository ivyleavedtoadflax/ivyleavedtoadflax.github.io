...
Knitr is awesome. Spend the time learning the features like hooks. These allow you to write commands that can automatically be executed whenever you create a code chunk, which can be great for things you do repetitively, like plotting:
...
![plot of chunk 2015-04-20-plot.mar-example](/figures/2015-04-20-plot.mar-example-1.png) 
